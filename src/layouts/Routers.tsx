...
const ManageAccount = lazy(
  () => import("../app/pages/Manage/Admin/ManageAccount")
);
const ManageFeild = lazy(() => import("../app/pages/Manage/Admin/ManageField"));
const ManageBooking = lazy(
  () => import("../app/pages/Manage/FacilityOwner/ManageBooking")
);
const ManageField = lazy(
  () => import("../app/pages/Manage/FacilityOwner/ManageField")
);
