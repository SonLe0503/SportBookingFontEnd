...
const DashBoardAdmin = () => {
  ...
  const config2 = {
    data: [
      { type: "Cầu lông", value: 1000000000 },
      { type: "Bóng đá", value: 500000000 },
      { type: "Pickleball", value: 500000000 },
    ],
    angleField: "value",
    colorField: "type",
    innerRadius: 0.6,
      ...
      <div className="flex w-full p-2 gap-4">
        <div className="flex flex-col gap-4 w-[49%]">
          ...
          <div className="bg-[#FFFFFF] shadow-[0_3px_10px_rgb(0,0,0,0.2)] p-2 rounded-[15px] flex-col flex">
            <div className="text-center text-gray-700"> Tỷ lệ doanh thu từ các môn thể thao</div>
            <Pie {...config2}/>
          </div>
        </div>
        <div className="flex flex-col gap-4 w-[49%]">
          <div className="bg-[#FFFFFF] shadow-[0_3px_10px_rgb(0,0,0,0.2)] p-2 rounded-[15px] flex flex-col">
            <div className="text-center text-gray-700">Thống kê lượt đặt sân hàng tháng</div>
            <Line {...config1} />
          </div>
        </div>
      </div>
